...
class CustomFontUtils {
    ...
    private static final String TAG = "CustomFontUtils";
    ...
    private static Typeface selectTypeface(Context context, String fontName, int textStyle) {
        ...
        if (fontName.contentEquals(context.getString(R.string.font_name_source_amatic_regular))) {
            return FontCache.getTypeface(context.getResources().getString(R.string.font_name_source_amatic_regular), context);
        } else if (fontName.contentEquals(context.getString(R.string.font_name_source_amatic_regular))) {
            return FontCache.getTypeface(context.getResources().getString(R.string.font_name_source_amatic_regular), context);
